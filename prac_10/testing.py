...
def format_phrase_as_sentence(phrase):
    """
    Format a phrase to start with a capital letter and end with a single full stop.
...
def run_tests():
    ...
    car = Car()
    assert car.fuel == 0, "Car does not set fuel correctly when no value is provided"
